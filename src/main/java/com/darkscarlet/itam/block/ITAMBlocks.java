...
public class ITAMBlocks{
    ...
    public static final Block ANIMA_ORE = new Block(FabricBlockSettings.of(Material.METAL).hardness(4.0f));
...
//
        Registry.register(Registry.BLOCK,new Identifier(ITAMMod.MODID,"anima_ore"),ANIMA_ORE);
        Registry.register(Registry.ITEM,new Identifier(ITAMMod.MODID,"anima_ore"),new BlockItem(ANIMA_ORE,new Item.Settings().group(ItemGroup.BUILDING_BLOCKS)));
